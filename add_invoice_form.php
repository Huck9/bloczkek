...
if (isset($_SESSION) && isset($_SESSION['name']) && $_SESSION['role'] == "worker") {
    ...
    <form method="post" action="add_invoice.php" enctype="multipart/form-data" style="margin-top:30px">
        ...
        <div class="inputs">
            ...
            <div class="form-group"><label>Numer Faktury:</label> <input type="text" name="invoiceNumber" class="form-control"></div>
            <div class="form-group"><label>Wartość netto:</label> <input type="number" step="0.01" name="nettoValue"
                                                                         class="form-control"></div>
            <div class="form-group"><label>Wartość VAT:</label> <input type="number" step="0.01" name="vatValue" class="form-control">
            </div>
            <div class="form-group"><label>Watrosc brutto:</label> <input type="number" step="0.01" name="bruttoValue"
                                                                          class="form-control"></div>
            <div class="form-group"><label>Data faktury:</label> <input type="date" name="date" class="form-control"></div>
